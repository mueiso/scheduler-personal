package com.myproject.schedulerpersonal.user.controller;
...
import com.myproject.schedulerpersonal.user.service.UserService;
...
public class UserController {
	...
	// 유저 생성
	@PostMapping
	public CommonResponse<UserResponseDto> saveUser(UserRequestDto userRequestDto) {
